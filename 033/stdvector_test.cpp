...
//            EXPECT(2 == v.capacity()); // not mandatory
    ...
    {
        {
            myvector<char> v1 = {'A', 'B', 'C'};
            myvector<char> v2 = {'A', 'B'};
            v1.swap(v2);

            EXPECT('A' == *std::next(v1.begin(), 0));
            EXPECT('B' == *std::next(v1.begin(), 1));
            EXPECT(2 == std::distance(v1.begin(), v1.end()));
            EXPECT(2 == v1.size());
            EXPECT(2 == v1.capacity());
            EXPECT('A' == *std::next(v2.begin(), 0));
            EXPECT('B' == *std::next(v2.begin(), 1));
            EXPECT('C' == *std::next(v2.begin(), 2));
            EXPECT(3 == std::distance(v2.begin(), v2.end()));
            EXPECT(3 == v2.size());
            EXPECT(3 == v2.capacity());
        }
        {
            myvector<char> v1 = {'A', 'B', 'C'};
            myvector<char> v2;
            ...
            EXPECT(0 == std::distance(v1.begin(), v1.end()));
            EXPECT(0 == v1.size());
            EXPECT(0 == v1.capacity());
            EXPECT('A' == *std::next(v2.begin(), 0));
            EXPECT('B' == *std::next(v2.begin(), 1));
            EXPECT('C' == *std::next(v2.begin(), 2));
            EXPECT(3 == std::distance(v2.begin(), v2.end()));
        ...
        }
        {
            ...
            EXPECT(1 == *std::next(v1.begin(), 0));
            EXPECT(2 == *std::next(v1.begin(), 1));
            EXPECT(2 == std::distance(v1.begin(), v1.end()));
            EXPECT(2 == v1.size());
            EXPECT(2 == v1.capacity());
            EXPECT(1 == *std::next(v2.begin(), 0));
            EXPECT(2 == *std::next(v2.begin(), 1));
            EXPECT(3 == *std::next(v2.begin(), 2));
            EXPECT(3 == std::distance(v2.begin(), v2.end()));
            EXPECT(3 == v2.size());
            EXPECT(3 == v2.capacity());
        }
        ...
        {
            myvector<double> v1 = {0.5, 1.0, 1.5};
            myvector<double> v2 = {0.5, 1.0};
            v1.swap(v2);

            EXPECT(0.5 == *std::next(v1.begin(), 0));
            EXPECT(1.0 == *std::next(v1.begin(), 1));
            EXPECT(2 == std::distance(v1.begin(), v1.end()));
            EXPECT(2 == v1.size());
            EXPECT(2 == v1.capacity());
            EXPECT(0.5 == *std::next(v2.begin(), 0));
            EXPECT(1.0 == *std::next(v2.begin(), 1));
            EXPECT(1.5 == *std::next(v2.begin(), 2));
            EXPECT(3 == std::distance(v2.begin(), v2.end()));
            EXPECT(3 == v2.size());
            EXPECT(3 == v2.capacity());
        }
        ...
        {
            myvector<noncopyable> v1(3);
            myvector<noncopyable> v2(2);
            v1.swap(v2);
        ...
        {
            myvector<unmovable> v1(3);
            myvector<unmovable> v2(2);
            v1.swap(v2);
    ...
    CASE("032: operator==, operator!=")
    {
        {
            myvector<int> v1{1, 2, 3};
            myvector<int> v2{3, 2, 1};
            myvector<int> v3{1, 2};
            myvector<int> v4{1, 2, 3, 4};
            myvector<int> v5{1, 2, 3, 4};
            v5.resize(3);
    ...
    CASE("033: operator<, operator<=, operator>, operator>=")
    {
        {
            myvector<int> v1{1, 2, 3};
            myvector<int> v2{3, 2, 1};
