...
private:
     ...
     */
    template <class RandomIt>
    RandomIt mynext(RandomIt first, size_type n, std::random_access_iterator_tag) const
    {
        if ((first + n) >= first) { // confirm never overflows
            return first + n;
        }
        else {
            return mynext(first, n, std::input_iterator_tag());
        }
    }
    /////////////////////////////////////////////////////////////////////////////

    template <class InputIt>
    InputIt mynext(InputIt first, size_type n, std::input_iterator_tag) const
    {
        InputIt ret = first;
